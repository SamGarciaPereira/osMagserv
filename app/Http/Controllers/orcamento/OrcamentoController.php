...
class OrcamentoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'status' => 'required|string|in:Pendente,Em Andamento,Em Validação,Validado,Enviado,Aprovado,Cancelado',
            ...
            'cep_obra' => 'nullable|string|max:9',
            'cidade_obra' => 'nullable|string',
            'uf_obra' => 'nullable|string|max:2',
            'logradouro_obra' => 'nullable|string',
            'bairro_obra' => 'nullable|string',
            'numero_obra' => 'nullable|string',
        ],[
