  ...
  <div class="bg-white p-6 rounded-lg shadow-sm mb-6 border border-gray-200">
    <form method="GET" action="{{ route('financeiro.contas-pagar.index') }}" id="filter-form" class="grid grid-cols-1 md:grid-cols-20 gap-4 items-end">
      ...
      <div class="md:col-span-4">
        ...
        <input type="month" name="data_inicio" id="data_inicio" value="{{ $inputInicio }}" required class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-blue-500 focus:border-blue-500 outline-none transition-all">
      </div>
