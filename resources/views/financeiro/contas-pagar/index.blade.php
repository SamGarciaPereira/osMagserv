...
<div class="bg-white p-6 rounded-lg shadow-sm mb-6 border border-gray-200">
    <form method="GET" action="{{ route('financeiro.contas-pagar.index') }}" class="grid grid-cols-1 md:grid-cols-20 gap-4 items-end">
                                ...
                                <div class="flex flex-col gap-2 md:w-1/3">
                                    <div class="bg-blue-50 border border-blue-200 rounded-md p-3 h-full">
                                        <div class="flex justify-between items-center mb-3 border-b border-blue-200 pb-2">
                                            ...
                                            <button type="button" 
                                                    onclick='openGeneralHistoryModal(@json($conta->history), @json($labelsContasPagar))' 
