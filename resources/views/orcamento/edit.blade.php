                ...
                <div class="lg:col-span-3 border-gray-200">
                    ...
                    <div class="flex gap-4 mb-2">
                        <label class="inline-flex items-center cursor-pointer">
                            <input type="radio" name="tipo_endereco" value="cliente" id="radio_cliente" 
                                class="form-radio text-blue-600 focus:ring-blue-500"
                                {{ !$temEnderecoObra ? 'checked' : '' }}>
                            <span class="ml-2 text-gray-700">Mesmo endereço do Cliente</span>
                        </label>

                        <label class="inline-flex items-center cursor-pointer">
                            <input type="radio" name="tipo_endereco" value="obra" id="radio_obra" 
                                class="form-radio text-blue-600 focus:ring-blue-500"
                                {{ $temEnderecoObra ? 'checked' : '' }}>
                    ...
                    <div id="endereco_obra_container" class="{{ $temEnderecoObra ? '' : 'hidden' }} grid grid-cols-1 md:grid-cols-12 gap-4 bg-gray-50 p-4 rounded-lg border border-gray-200">
                        ...
                        <div class="md:col-span-3">
                            ...
                            <div class="flex gap-2">
                                <input type="text" name="cep_obra" id="cep_obra" maxlength="9" placeholder="00000-000"
                                    value="{{ old('cep_obra', $orcamento->cep_obra) }}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="uf_obra" id="uf_obra" tabindex="-1" readonly
                                value="{{ old('uf_obra', $orcamento->uf_obra) }}"
                        ...
                        <div class="md:col-span-4">
                            ...
                            <input type="text" name="cidade_obra" id="cidade_obra" 
                                value="{{ old('cidade_obra', $orcamento->cidade_obra) }}"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        ...
                        <div class="md:col-span-3">
                            ...
                            <input type="text" name="bairro_obra" id="bairro_obra" 
                                value="{{ old('bairro_obra', $orcamento->bairro_obra) }}"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        ...
                        <div class="md:col-span-10">
                            ...
                            <input type="text" name="logradouro_obra" id="logradouro_obra" 
                                value="{{ old('logradouro_obra', $orcamento->logradouro_obra) }}"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="numero_obra" id="numero_obra" 
                                value="{{ old('numero_obra', $orcamento->numero_obra) }}"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                        </div>
                    </div>
                </div>
