          ...
          <div class="sm:flex sm:items-start">
            ...
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
              ...
              <div class="mt-2">
                ...
                <input type="file" name="arquivo" required accept=".pdf,image/*,.xlsx,.xls,.csv" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                @if (!auth()->user()->isSupervisor())
                  <div class="mt-4 p-3 bg-red-50 border border-red-100 rounded-md">
                    <label class="flex items-center space-x-2 cursor-pointer">
                      <input type="checkbox" name="is_confidencial" value="1" class="form-checkbox text-red-600 border-red-300 rounded focus:ring-red-500">
                      <span class="text-sm font-medium text-red-800">Arquivo Confidencial</span>
                    </label>
                    <p class="text-xs text-red-600 mt-1 ml-6">Marque se este arquivo contiver valores financeiros, propostas ou notas fiscais.</p>
                  </div>
                @endif
              </div>
            </div>
