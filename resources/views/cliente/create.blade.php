...
@section('content')
  ...
  <div class="p-4 sm:p-6 lg:p-8">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 sm:mb-8">
      <div>
        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Cadastrar Novo Cliente</h1>
        <p class="text-gray-600 mt-1 text-sm sm:text-base">Preencha os dados abaixo para adicionar um novo cliente ao sistema.</p>
      </div>
      ...
      <form action="{{ route('clientes.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          <div>
            ...
            <input type="text" id="nome" name="nome" class="w-full px-3 py-2 sm:px-4 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Ex: João da Silva ou Magserv LTDA" required>
          </div>
          <div>
            ...
            <input type="text" id="documento" name="documento" class="w-full px-3 py-2 sm:px-4 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Ex: 123.456.789-00" required>
            @error('documento')
          ...
          <div>
            ...
            <input type="text" id="responsavel" name="responsavel" class="w-full px-3 py-2 sm:px-4 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Ex: Marco Pereira">
          </div>
          <div>
            <label for="email" class="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">E-mail</label>
            <input type="email" id="email" name="email" class="w-full px-3 py-2 sm:px-4 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Ex: contato@exemplo.com">
            @error('email')
              <p class="text-red-500 text-xs sm:text-sm mt-1">{{ $message }}</p>
            @enderror
          </div>
          ...
          <div>
            ...
            <input type="tel" id="telefone" name="telefone" class="w-full px-3 py-2 sm:px-4 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Ex: (11) 99999-8888">
            @error('telefone')
              <p class="text-red-500 text-xs sm:text-sm mt-1">{{ $message }}</p>
            @enderror
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-6 gap-4 sm:gap-6">
          ...
          <div class="md:col-span-4">
            <label for="logradouro" class="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">Logradouro (Rua, Av, etc.)</label>
            <input type="text" id="logradouro" name="logradouro" class="w-full px-3 py-2 sm:px-4 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Ex: Av. Paulista">
          </div>
          <div class="md:col-span-2">
            <label for="numero" class="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">Número</label>
            <input type="text" id="numero" name="numero" class="w-full px-3 py-2 sm:px-4 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Ex: 1500">
          </div>
          <div class="md:col-span-4">
            <label for="bairro" class="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">Bairro</label>
            <input type="text" id="bairro" name="bairro" class="w-full px-3 py-2 sm:px-4 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Ex: Bela Vista">
          </div>
          <div class="md:col-span-3">
            <label for="cidade" class="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">Cidade</label>
            <input type="text" id="cidade" name="cidade" class="w-full px-3 py-2 sm:px-4 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Ex: São Paulo">
          </div>
          <div class="md:col-span-3">
            <label for="estado" class="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">Estado</label>
            <input type="text" id="estado" name="estado" class="w-full px-3 py-2 sm:px-4 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Ex: SP">
          </div>
        </div>
