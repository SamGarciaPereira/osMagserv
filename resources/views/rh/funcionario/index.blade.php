                ...
                <table class="w-full table-auto">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Status Docs</th>
                    ...
                    <tbody>
                        @forelse ($funcionariosFixos as $funcionario)
                            <tr>
                                ...
                                <td class="px-4 py-2 whitespace-nowrap">
                                    <x-status-badge :status="$funcionario->status_documentos" />
                                </td>
