    ...
    <form method="GET" action="{{ route('home') }}" class="bg-white p-3 rounded-lg shadow-sm border border-gray-200">
      <div class="flex flex-col sm:flex-row items-center gap-3">
        <div class="flex items-center gap-2">
          ...
          <input type="month" name="data_inicio" id="data_inicio" value="{{ $inputInicio }}" required class="border-gray-300 rounded-md text-sm py-1.5 px-3 focus:ring-blue-500 focus:border-blue-500">
        </div>
        ...
        <div class="flex items-center gap-2">
          ...
          <input type="month" name="data_fim" id="data_fim" value="{{ $inputFim }}" class="border-gray-300 rounded-md text-sm py-1.5 px-3 focus:ring-blue-500 focus:border-blue-500">
        </div>
      ...
      <div class="lg:col-span-2 bg-white p-6 rounded-lg shadow-md">
        <div class="flex flex-col sm:flex-row justify-between items-center mb-4 gap-4">
          ...
          <div class="flex bg-gray-100 p-1 rounded-lg">
            <button onclick="updateChart('receita')" id="btnReceita" class="px-4 py-1.5 text-sm font-medium rounded-md shadow-sm bg-white text-blue-600 transition-all duration-200">
              Receitas
            </button>
            <button onclick="updateChart('despesa')" id="btnDespesa" class="px-4 py-1.5 text-sm font-medium rounded-md text-gray-500 hover:text-gray-700 transition-all duration-200">
              Despesas
            </button>
          </div>
        </div>
